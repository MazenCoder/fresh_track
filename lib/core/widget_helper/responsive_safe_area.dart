                    ...
                    return AnimatedBuilder(
                      ...
                      builder: (context, child) {
                        return AnimatedPositioned(
                          ...
                          left: logic.state.reverse ? 120 : -120,
                          top: -140,
                          curve: Curves.easeIn,
                          child: RotationTransition(
                            turns: AlwaysStoppedAnimation(
                                logic.state.reverse ?
                                logic.animation.value/500 :
                                -logic.animation.value/500,
                            ),
                            child: Container(
                              height: Get.width,
                              ...
                              decoration: BoxDecoration(
                                  shape: BoxShape.circle,
                                  gradient: LinearGradient(
                                    begin: logic.state.reverse ? Alignment.topRight : Alignment.topLeft,
                                    end: logic.state.reverse ? Alignment.bottomLeft : Alignment.bottomRight,
                                    colors: [
                                      primaryColor,
                                      primaryColor.withOpacity(0.4),
                                      primaryColor.withOpacity(0),
                            ...
                            child: RotationTransition(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    shape: BoxShape.circle,
                                    gradient: LinearGradient(
                                      begin: logic.state.reverse ? Alignment.bottomLeft : Alignment.bottomRight,
                                      end: logic.state.reverse ? Alignment.topRight : Alignment.topLeft,
                                      colors: [
                                        greenColor,
